...
describe('BflAPI Class', () => {
  ...
  describe('Configuration', () => {
    ...
    it('should have valid endpoint paths', () => {
      Object.entries(MODEL_ENDPOINTS).forEach(([_model, endpoint]) => {
    ...
    it('should have expected models', () => {
      ...
      expectedModels.forEach(model => {
        expect(MODEL_ENDPOINTS[model as keyof typeof MODEL_ENDPOINTS]).toBeDefined();
      });
    });
  });
  ...
  describe('FLUX.1 Fill [pro] Generation', () => {
    it('should throw error if image is missing', async () => {
      await expect(async () => {
        ...
        } as Parameters<typeof api.generateFluxProFill>[0]);
  ...
  describe('FLUX.1 Fill [pro] Finetune Generation', () => {
    ...
    it('should throw error if finetune_id is missing', async () => {
      await expect(async () => {
        ...
        } as Parameters<typeof api.generateFluxProFillFinetuned>[0]);
    ...
    it('should throw error if image is missing', async () => {
      await expect(async () => {
        await api.generateFluxProExpand({
          ...
          top: 512
        } as Parameters<typeof api.generateFluxProExpand>[0]);
  ...
  describe('Error Handling - Additional Status Codes', () => {
    ...
    it('should sanitize 400 errors in production', async () => {
      ...
      try {
        ...
        expect((error as Error).message).not.toContain('Sensitive internal');
      }
    ...
    it('should sanitize 403 errors in production', async () => {
      ...
      try {
        ...
        expect((error as Error).message).not.toContain('Detailed permission');
      }
    ...
    it('should sanitize 500 errors in production', async () => {
      ...
      try {
        ...
        expect((error as Error).message).not.toContain('sensitive data');
      }
